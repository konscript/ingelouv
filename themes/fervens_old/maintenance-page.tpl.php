  ...
  <div id="bg"><div id="bg-t">
    <div id="page">
      ...
      <div id="footer" class="clear-both">
        ...
        <div id="i-love-sm">
          <a href="http://smashingmagazine.com" title="<?php print t('I love Smashing Magazine!'); ?>"><img src="<?php print $base_path . path_to_theme() . '/images/i-love-sm.png'; ?>" alt="<?php print t('I love Smashing Magazine!'); ?>" /></a>
        </div>
